...
//            sendIntent.putExtra(Intent.EXTRA_TEXT, "The user's latitude is"+lat.toString()+" The user's longitude is"+lon.toString());
//            sendIntent.setType("text/plain");
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        lat = 16.780566833333335; //greetings[0].getLatitude();
        lon = 81.69936216666666 ;
